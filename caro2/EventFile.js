...
function Loaded()
{
	...
	imgp.style.backgroundImage = "url('https://123emoji.com/wp-content/uploads/2017/08/sticker-99.png')";
...
function Click(id)
{
	...
	var path = "url('https://123emoji.com/wp-content/uploads/2017/08/sticker-99.png')";
	if (CPlayer == 1) path = "url('https://i.pinimg.com/originals/49/03/db/4903db6a9815df2520115341422ea9ae.png')";
	...
	if (!AI)
	{
		...
		var iplayer = "url('https://123emoji.com/wp-content/uploads/2017/08/sticker-99.png')";
		if (CPlayer == 1) iplayer = "url('https://i.pinimg.com/originals/49/03/db/4903db6a9815df2520115341422ea9ae.png')";
		var imgp = document.getElementById("imgPlayer");
